...
const Index = () => {
  ...
  const colLoads3D = useMemo(() => {
    ...
    try {
      ...
      return getColumnLoads3D(frames, beamsWithLoads, columns, mat, effectiveFrameEndReleases, autoDetectedConnections, slabs, slabProps, false, beamStiffnessFactor, colStiffnessFactor, colRigidEndOffsets, manualJointOverrides, state.ribbedSlabProps);
    } catch {
